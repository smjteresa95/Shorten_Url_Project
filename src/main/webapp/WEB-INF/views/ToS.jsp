					...
					<div class="container">
						...
						<article class="box post" >
								...
								<div class="form-floating">
									<textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="resize: none; height: 1000px; text-align: left;">
제 1 장 총 칙
...
(시행일) 이 약관은 2015년 01월부터 시행합니다.
								  ...
								  <div class="form-check" style="margin-top: 20px;">
									<input class="form-check-input" type="radio" name="ag" id="flexRadioDefault1" value="ok" onclick="checkOk()">
									<label class="form-check-label" for="flexRadioDefault1">
									  동의
									</label>
								  </div>
								  <div class="form-check">
									<input class="form-check-input" type="radio" name="ag" id="flexRadioDefault2" value="unOk" onclick="checkOk()">
									<label class="form-check-label" for="flexRadioDefault2">
									  동의하지 않음
									</label>
								  </div>
								  <div style="text-align: center;">
									  <button type="button" class="btn btn-secondary nextBtn" style="width: 40%;">다음</button>
								  </div>
							</article>
					</div>
				</section>
